...
let demoCarriersStore = [
  ...
  {
    id: 'OTR-639404',
    carrier_id: 'OTR-639404',
    company_name: 'OTR Relay Drayage',
    contact_person: 'James Peterson',
    phone: '(800) 555-0488',
    email: 'james@otrrelay.com',
